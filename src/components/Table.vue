<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    >
      ...
      >
        <tr>
          <th v-for="col in columns" :key="col.label" scope="col" class="px-2 py-3">{{ col.label }}</th>
      ...
      <tbody>
        ...
        >
          ...
          <td v-for="col in columns" :key="col.label" class="px-2 py-4">{{ row[col.property] }}</td>
          
          <td class="flex items-center px-2 py-4 gap-4">
